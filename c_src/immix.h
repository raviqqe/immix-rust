...
#define IMMIX_LINES_IN_BLOCK                                                   \
  (1 << (IMMIX_LOG_BYTES_IN_BLOCK - IMMIX_LOG_BYTES_IN_LINE))
...
inline void init_object(ImmixMutatorLocal *mutator, Address addr,
                        uint8_t encode) __attribute__((always_inline));
inline void init_object(ImmixMutatorLocal *mutator, Address addr,
                        uint8_t encode) {
...
inline Address ImmixMutatorLocal_alloc(ImmixMutatorLocal *mutator, int size,
                                       int align)
    __attribute__((always_inline));
inline Address ImmixMutatorLocal_alloc(ImmixMutatorLocal *mutator, int size,
                                       int align) {
...
inline void mark_line_live(LineMark *line_mark_table, int line_mark_table_len,
