...
int get_registers_count() { return 16; }

uintptr_t *get_registers() {
  uintptr_t rax, rbx, rcx, rdx, rbp, rsp, rsi, rdi, r8, r9, r10, r11, r12, r13,
      r14, r15;
  ...
  __asm__("mov %%rax, %0 \n"
          ...
          "mov %%r14, %14\n"
          "mov %%r15, %15\n"
          : "=m"(rax), "=m"(rbx), "=m"(rcx), "=m"(rdx), "=m"(rbp), "=m"(rsp),
            "=m"(rsi), "=m"(rdi), "=m"(r8), "=m"(r9), "=m"(r10), "=m"(r11),
...
uintptr_t get_low_water_mark() { return low_water_mark; }
